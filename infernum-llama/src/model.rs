...
use infernum::cuda::ops::{
    ...
    fused_attention_decode_indirect, fused_attention_prefill, linear, matmul, matmul_bf16_f32,
    precompute_rope_cache, reinterpret_tensor, repeat_kv, rms_norm, rms_norm_inplace, swiglu,
