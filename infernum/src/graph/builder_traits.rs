...
// ---------------------------------------------------------------------------
// ArgmaxOps — device-side argmax
// ---------------------------------------------------------------------------

/// Graph builder method for on-device argmax (avoids D→H transfer of full logits).
pub trait GraphArgmaxOps {
...
impl<B: Backend + MatmulOps + ContextBackend> GraphArgmaxOps for Graph<B> {
    fn add_argmax_last(&mut self, logits: OutputRef) -> OutputRef {
