...
//!
//! [`Scheduler2`] tracks per-request state and decides which requests to
...
mod tests {
    ...
    fn make_scheduler(max_batch: usize, block_size: usize, num_blocks: usize) -> Scheduler2 {
        Scheduler2::new(&BatchConfig {
    ...
    #[test]
    fn chunked_prefill() {
        let mut sched = Scheduler2::new(&BatchConfig {
            max_batch_size: 4,
